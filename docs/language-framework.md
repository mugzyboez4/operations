# Campaign Operations — Language Framework
## The canonical reference. Same words everywhere.

---

## THE FOUR PHASES

Every campaign moves through four phases. Phase names are verbs — campaigns are things we *do*.
...
Gates are checkpoints between phases. Each gate is a question. You don't move until the answer is yes.
...
Information flows forward through the week. Each day has a purpose.

| Day | Meeting | Type | Phase | Status | Time |
|-----|---------|------|-------|--------|------|
...
**Campaign Ops is the connective tissue.** Nobody discovers something Wednesday that was decided Tuesday.

---

## THE ARTIST LIFECYCLE (RITUAL SPINE)

Six milestone-triggered meetings, mapped to phases and gates. Built on A&R Operations' Ritual Spine (Adonis Sutherlin, March 2026), updated with phase language.

| Meeting | Trigger | Owner | Phase/Gate | Type | Duration |
|---------|---------|-------|-----------|------|----------|
...
Not a meeting. A weekly intelligence product compiled by Campaign Ops, distributed Friday afternoon.

**Sections:**

1. **What Released This Week** — results from recent drops. CL submissions + trackGPS data.
2. **Playlist Recap** — from Commercial Partnerships' weekly report. Major adds, position changes, editorial features.
3. **Press & Media Moments** — big hits from Publicity. Interviews, TV, coverage.
4. **Trends & Signals** — streaming signals from Analytics + social/cultural moments from Audience Dev.
5. **Looking Ahead** — next week's releases + gate transitions (who passed a gate, who's approaching one).

**Input sources:** CL submissions (Airtable/email) · trackGPS · Commercial Partnerships weekly report · Publicity team · Audience Dev · Strategic Analytics.
...
### Meetings → Phases
| Phase | Weekly Meeting | Artist Meeting |
|-------|---------------|----------------|
...
### Tools → Meetings
| Meeting | On Screen | Source |
|---------|-----------|--------|
| Foundation Room | Artist audience snapshots | Crawley one-pagers |
| Workability Check | Workability dashboard (red items only) | Release Runway |
| Active Projects | Campaign timelines + workability | Airtable + Runway |
| DELIVER Wrap | Release results + playlist recap + press | trackGPS + Commercial Partnerships |
...
1. **Phase names always ALL CAPS** when referring to the phase: "KWN is in ANNOUNCE."
2. **Gate names are always the question:** "They haven't passed CAN WE EXECUTE? yet."
3. **Phase names are verbs, gates are questions.** We plan, announce, execute, deliver. We ask: can we plan? Can we announce?
4. **Don't say "stage" when you mean "phase."** Phases are what we do. Gates are what we pass through.
5. **Same words in Airtable, briefs, agendas, timelines, conversation.** No synonyms. PLAN is always PLAN, not "setup" or "pre-campaign" or "development" or "foundation."
6. **Workability has one definition:** art, music, and clearances are done. Art delivered, master approved, samples cleared.

---

## WHAT CAMPAIGN OPS OWNS

**Track** — what phase is each artist in
**Surface** — what's blocked, what's next
**Flag** — red items before they become crises
**Prompt** — departments to clear their gates
**Confirm** — decisions are captured and routed

**We don't own:** Approve · Decide · Manage
...
*Campaign Operations · Building together.*
*Every phase · Every gate · Together.*
